...
for (s in 1:1000){
  ...
  temp.31.data <- data.frame(Temp=29)
...
data.frame(temp=c(29,72), lower.CI=c(CI.31[1],CI.72[1]), upper.CI=c(CI.31[2],CI.72[2]))
...
hist(results[,1],
     ...
     xlim=c(0,1),
     main=' ')
mtext('(a) Probability of failure at 29 °F', side = 3, padj = -2.5)
